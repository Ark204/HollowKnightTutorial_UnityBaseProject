    ...
    public abstract class AbstractProjectile : MonoBehaviour
    {
        ...
        protected void DestroyProjectile()
        {
            ...
            if (splatterSound != null)
                SoundManager.Instance.PlaySoundAtLocation(splatterSound, transform.position, 0.75f);//Play sound

            EffectManager.Instance.PlayOneShot(explosionEffect, transform.position);//Play Particle
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            if (player != null)
            {
                ...
                player.Hurt((int)damage, force * pushPower);
            }
